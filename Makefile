...
all-pestilence: $(LIBS_MAKE_RULE) $(BIN_PATH)
...
$(OBJDIR)/pestilence_64.c.o: stub/common/pestilence.c
	$(call qcmd,$(MKDIR) -p $(@D))
	$(call bcmd,cc,$<,$(CC) -c $(CFLAGS) -o $@ $<)

# Make pestilence 32

$(OBJDIR)/pestilence_32.c.o: stub/common/pestilence.c
	$(call qcmd,$(MKDIR) -p $(@D))
	$(call bcmd,cc,$<,$(CC) -c $(CFLAGS) -o $@ $<)
...
$(OBJDIR)/stub64.o: $(OBJDIR)/stub/64/stub.S.o $(OBJDIR)/stub/64/stub.c.o $(OBJDIR)/stub/64/strings.c.o $(OBJDIR)/stub/64/syscall.c.o $(OBJDIR)/stub/64/elf.c.o $(OBJDIR)/stub/64/elf/elf_reader32.c.o $(OBJDIR)/stub/64/elf/elf_reader64.c.o $(OBJDIR)/stub/64/elf/raw_data_rw.c.o $(OBJDIR)/stub/64/elf_loader.c.o $(OBJDIR)/stub/64/pestilence.c.o  $(OBJDIR)/stub/64/protect_range.c.o $(OBJDIR)/stub/packer64/xtea_crypt_64.S.o $(OBJDIR)/stub/64/utils/sort.c.o
...
.PHONY: all-pestilence norminette
